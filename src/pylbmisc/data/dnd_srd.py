srd = [
    ...
    {'name': 'Case, Crossbow Bolt', 'desc': 'This wooden case can hold up to twenty crossbow bolts.'},
    {
    ...
    {'name': 'Chain', 'desc': 'A chain has 10 hit points. It can be burst with a successful DC 20 Strength check.'},
    {
        'name': "Climber's Kit.",
    ...
    {'name': 'Quiver', 'desc': 'A quiver can hold up to 20 arrows.'},
    {
        'name': 'Ram, Portable',
    ...
    },
    {
        ...
        'desc': 'A scale includes a small balance, pans, and a suitable assortment of weights up to 2 pounds. With it, you can measure the exact weight of small objects, such as raw precious metals or trade goods, to help determine their worth. Spellbook. Essential for wizards, a spellbook is a leather-bound tome with 100 blank vellum pages suitable for recording spells.',
    },
    {'name': 'Spyglass', 'desc': 'Objects viewed through a spyglass are magnified to twice their size.'},
    {'name': 'Tent', 'desc': 'A simple and portable canvas shelter, a tent sleeps two.'},
    {
        'name': 'Tinderbox',
    ...
    },
    {
        ...
        'features': {
            ...
            'prof-skills': 'Choose two from Animal Handling, Athletics, Intimidation, Nature, Perception, and Survival',
    ...
    },
    {
        ...
        'features': {
            'hit-dice': '1d8',
            'hp-at-1st-level': '8 + your Constitution modifier',
            'hp-at-higher-levels': '1d8 (or 5) + your Constitution modifier per cleric level after 1st',
            'prof-armor': 'Light armor, medium armor, shields',
            'prof-weapons': 'Simple weapons',
            'prof-tools': 'None',
            'prof-saving-throws': 'Wisdom, Charisma',
            'prof-skills': 'Choose two from History, Insight, Medicine, Persuasion, and Religion',
    ...
    },
    {
        ...
        'features': {
            'hit-dice': '1d8',
            'hp-at-1st-level': '8 + your Constitution modifier',
            'hp-at-higher-levels': '1d8 (or 5) + your Constitution modifier per druid level after 1st',
            'prof-armor': 'Light armor, medium armor, shields (druids will not wear armor or use shields made of metal)',
            'prof-weapons': 'Clubs, daggers, darts, javelins, maces, quarterstaffs, scimitars, sickles, slings, spears',
            'prof-tools': 'Herbalism kit',
            'prof-saving-throws': 'Intelligence, Wisdom',
            'prof-skills': 'Choose two from Arcana, Animal Handling, Insight, Medicine, Nature, Perception, Religion, and Survival',
    ...
    },
    {
        ...
        'features': {
            ...
            'prof-armor': 'All armor, shields',
            'prof-weapons': 'Simple weapons, martial weapons',
            'prof-tools': 'None',
            'prof-saving-throws': 'Strength, Constitution',
            'prof-skills': 'Choose two skills from Acrobatics, Animal, Handling, Athletics, History, Insight, Intimidation, Perception, and Survival',
        ...
        'subtypes-name': 'Martial Archetypes',
        'subtypes': [
            {
                'name': 'Champion',
    ...
    },
    {
        ...
        'features': {
            ...
            'prof-armor': 'None',
            'prof-weapons': 'Simple weapons, shortswords',
            'prof-tools': "Choose one type of artisan's tools or one musical instrument",
            'prof-saving-throws': 'Strength, Dexterity',
            'prof-skills': 'Choose two from Acrobatics, Athletics, History, Insight, Religion, and Stealth',
        ...
        'subtypes-name': 'Monastic Traditions',
        'subtypes': [
            {
    ...
    },
    {
        ...
        'features': {
            ...
            'prof-tools': 'None',
            'prof-saving-throws': 'Wisdom, Charisma',
            'prof-skills': 'Choose two from Athletics, Insight, Intimidation, Medicine, Persuasion, and Religion',
    ...
    },
    {
        ...
        'features': {
            'hit-dice': '1d10',
            'hp-at-1st-level': '10 + your Constitution modifier',
            'hp-at-higher-levels': '1d10 (or 6) + your Constitution modifier per ranger level after 1st',
            'prof-armor': 'Light armor, medium armor, shields',
            'prof-weapons': 'Simple weapons, martial weapons',
            'prof-tools': 'None',
            'prof-saving-throws': 'Strength, Dexterity',
            'prof-skills': 'Choose three from Animal Handling, Athletics, Insight, Investigation, Nature, Perception, Stealth, and Survival',
        ...
        'subtypes-name': 'Ranger Archetypes',
        'subtypes': [
            {
                'name': 'Hunter',
    ...
    },
    {
        ...
        'features': {
            ...
            'prof-armor': 'Light armor',
            'prof-weapons': 'Simple weapons, hand crossbows, longswords, rapiers, shortswords',
            'prof-tools': "Thieves' tools",
            'prof-saving-throws': 'Dexterity, Intelligence',
            'prof-skills': 'Choose four from Acrobatics, Athletics, Deception, Insight, Intimidation, Investigation, Perception, Performance, Persuasion, Sleight of Hand, and Stealth',
        ...
        'subtypes-name': 'Roguish Archetypes',
        'subtypes': [
            {
                'name': 'Thief',
    ...
    },
    {
        ...
        'features': {
            ...
            'prof-armor': 'None',
            'prof-weapons': 'Daggers, darts, slings, quarterstaffs, light crossbows',
            'prof-tools': 'None',
            'prof-saving-throws': 'Constitution, Charisma',
            'prof-skills': 'Choose two from Arcana, Deception, Insight, Intimidation, Persuasion, and Religion',
        ...
        'subtypes-name': 'Sorcerous Origins',
        'subtypes': [
            {
    ...
    },
    {
        ...
        'features': {
            ...
            'prof-tools': 'None',
            'prof-saving-throws': 'Wisdom, Charisma',
            'prof-skills': 'Choose two skills from Arcana, Deception, History, Intimidation, Investigation, Nature, and Religion',
        ...
        'subtypes-name': 'Otherworldly Patrons',
        'subtypes': [
            {
                'name': 'The Fiend',
    ...
    },
    {
        ...
        'features': {
            ...
            'prof-tools': 'None',
            'prof-saving-throws': 'Intelligence, Wisdom',
            'prof-skills': 'Choose two from Arcana, History, Insight, Investigation, Medicine, and Religion',
        ...
        'subtypes-name': 'Arcane Traditions',
        'subtypes': [
            {
    ...
    },
    {
        ...
        'speed': {'walk': 30},
        'speed-desc': '**_Speed._** Your base walking speed is 30 feet.',
    ...
    },
    {
        ...
        'speed': {'walk': 25},
        'speed-desc': '**_Speed._** Your base walking speed is 25 feet.',
    ...
    },
    {
        ...
        'asi': [{'attributes': ['Strength'], 'value': 2}, {'attributes': ['Constitution'], 'value': 1}],
    ...
    },
    {
        ...
        'asi': [{'attributes': ['Intelligence'], 'value': 1}, {'attributes': ['Charisma'], 'value': 2}],
    ...
    },
    {
        ...
        'saving_throw_ability': ['Strength', 'dexterity'],
    },
    {
        'name': 'Blade Barrier',
    ...
    {
        'name': 'Branding Smite',
        'desc': "The next time you hit a creature with a weapon attack before this spell ends, the weapon gleams with astral radiance as you strike. The attack deals an extra 2d6 radiant damage to the target, which becomes visible if it's invisible, and the target sheds dim light in a 5-\xad--foot radius and can't become invisible until the spell ends.",
    ...
    },
    {
        ...
        'shape': ' cube',
        'saving_throw_ability': ['strength', 'strength'],
    },
    {
    ...
    },
    {
        ...
        'higher_level': 'When you cast this spell with a 5th-\xadlevel spell slot, the duration is concentration, up to 10 minutes. When you use a 6th-\xadlevel spell slot, the duration is concentration, up to 1 hour. When you use a spell slot of 7th level or higher, the duration is concentration, up to 8 hours.',
        'page': 'phb 234',
        'range': '60 feet',
        'components': 'V, S',
        'ritual': 'no',
    ...
    {
        'name': 'Druidcraft',
        'desc': 'Whispering to the spirits of nature, you create one of the following effects within range: \n- You create a tiny, harmless sensory effect that predicts what the weather will be at your location for the next 24 hours. The effect might manifest as a golden orb for clear skies, a cloud for rain, falling snowflakes for snow, and so on. This effect persists for 1 round. \n- You instantly make a flower blossom, a seed pod open, or a leaf bud bloom. \n- You create an instantaneous, harmless sensory effect, such as falling leaves, a puff of wind, the sound of a small animal, or the faint odor of skunk. The effect must fit in a 5-\xad--foot cube. \n- You instantly light or snuff out a candle, a torch, or a small campfire.',
        'page': 'phb 236',
        'range': '30 feet',
        'components': 'V, S',
        'ritual': 'no',
    ...
    },
    {
        ...
        'saving_throw_ability': ['dexterity', 'constitution', 'strength'],
    },
    {
        'name': 'Eldritch Blast',
    ...
    },
    {
        ...
        'class': 'Wizard',
        'shape': ' sphere',
        'saving_throw_ability': ['constitution', 'strength'],
    },
    {
        'name': 'Gaseous Form',
    ...
    },
    {
        ...
        'class': 'Bard, Cleric, Wizard',
        'shape': ' sphere',
        'saving_throw_ability': ['Dexterity', 'intelligence'],
    },
    {
        'name': 'Goodberry',
    ...
    {
        'name': 'Magic Circle',
        'desc': "You create a 10-\xad--foot-\xad--radius, 20-\xad--foot-\xad--tall cylinder of magical energy centered on a point on the ground that you can see within range. Glowing runes appear wherever the cylinder intersects with the floor or other surface. Choose one or more of the following types of creatures: celestials, elementals, fey, fiends, or undead. The circle affects a creature of the chosen type in the following ways: \n- The creature can't willingly enter the cylinder by nonmagical means. If the creature tries to use teleportation or interplanar travel to do so, it must first succeed on a charisma saving throw. \n- The creature has disadvantage on attack rolls against targets within the cylinder. \n- Targets within the cylinder can't be charmed, frightened, or possessed by the creature.\nWhen you cast this spell, you can elect to cause its magic to operate in the reverse direction, preventing a creature of the specified type from leaving the cylinder and protecting targets outside it.",
    ...
    },
    {
        ...
        'class': 'Sorcerer, Wizard',
        'shape': ' cone',
        'saving_throw_ability': ['dexterity', 'constitution', 'wisdom'],
    },
    {
        'name': 'Prismatic Wall',
    ...
    {
        'name': 'Secret Chest',
        'desc': "You hide a chest, and all its contents, on the Ethereal Plane. You must touch the chest and the miniature replica that serves as a material component for the spell. The chest can contain up to 12 cubic feet of nonliving material (3 feet by 2 feet by 2 feet). While the chest remains on the Ethereal Plane, you can use an action and touch the replica to recall the chest. It appears in an unoccupied space on the ground within 5 feet of you. You can send the chest back to the Ethereal Plane by using an action and touching both the chest and the replica. After 60 days, there is a cumulative 5 percent chance per day that the spell's effect ends. This effect ends if you cast this spell again, if the smaller replica chest is destroyed, or if you choose to end the spell as an action. If the spell ends and the larger chest is on the Ethereal Plane, it is irretrievably lost.",
        'page': 'phb 254',
        'range': 'Touch',
        'components': 'V, S, M',
    ...
    },
    {
        ...
        'archetype': 'Warlock: Archfey',
        'patrons': 'Archfey',
        'saving_throw_ability': ['charisma', 'intelligence'],
    },
    {
        'name': 'Sending',
    ...
    {
        'name': 'Sequester',
        'desc': 'By means of this spell, a willing creature or an object can be hidden away, safe from detection for the duration. When you cast the spell and touch the target, it becomes invisible and can\'t be targeted by divination spells or perceived through scrying sensors created by divination spells. If the target is a creature, it falls into a state of suspended animation. Time ceases to flow for it, and it doesn\'t grow older. You can set a condition for the spell to end early. The condition can be anything you choose, but it must occur or be visible within 1 mile of the target. Examples include "after 1,000 years" or "when the tarrasque awakens." This spell also ends if the target takes any damage.',
        'page': 'phb 274',
        'range': 'Touch',
        'components': 'V, S, M',
    ...
    {
        'name': 'Shatter',
        'desc': "A sudden loud ringing noise, painfully intense, erupts from a point of your choice within range. Each creature in a 10-\xad--foot-\xad--radius sphere centered on that point must make a Constitution saving throw. A creature takes 3d8 thunder damage on a failed save, or half as much damage on a successful one. A creature made of inorganic material such as stone,crystal, or metal has disadvantage on this saving throw. A nonmagical object that isn't being worn or carried also takes the damage if it's in the spell's area.",
        'higher_level': 'When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d8 for each slot level above 2nd.',
        'page': 'phb 275',
        'range': '60 feet',
        'components': 'V, S, M',
    ...
    },
    {
        ...
        'class': 'Bard, Cleric, Wizard',
        'shape': ' sphere',
        'saving_throw_ability': ['constitution', 'intelligence', 'wisdom', 'charisma', 'intelligence'],
    },
    {
        'name': 'Telekinesis',
    ...
    },
    {
        ...
        'circles': 'Underdark',
        'shape': ' cube',
        'saving_throw_ability': ['dexterity', 'strength'],
    },
    {
        'name': 'Weird',
